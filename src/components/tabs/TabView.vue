...
const componentMap: Record<string, () => Promise<{ default: Component }>> = {
  ...
  'settings/user/UserManagement': () => import('@/views/settings/user/UserManagement.vue'),
  'settings/role/RoleManagement': () => import('@/views/settings/role/RoleManagement.vue'),
  'settings/menu/MenuManagement': () => import('@/views/settings/menu/MenuManagement.vue'),
